...
const reviewSchedule = [
  { when: "Dzień 1", what: "Lekcja, na której słowo lub struktura pojawia się pierwszy raz, zawsze w kontekście, nie na liście do zakucia." },
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-16 sm:px-8 sm:py-20">
      ...
      <p className="mt-5 text-lg leading-relaxed text-ink-soft">
        ...
        zweryfikować na pierwszym spotkaniu. Bez ogólnikowych haseł o „nowoczesnym podejściu”.
      </p>
      ...
      <div className="prose-article">
        ...
        <p>
          ...
          to kolejność odwrotna do naturalnej. Zaczynamy od próby wypowiedzenia myśli po
          angielsku, nawet niedoskonałej, a regułę gramatyczną wprowadzamy jako wyjaśnienie tego,
          co już próbowałeś powiedzieć. Dzięki temu reguła ma się do czego przykleić. Nie wisi w
        ...
        <p>
          ...
          zdolności językowych. Każde nowe słowo czy struktura wraca więc do ciebie w konkretnym
          rytmie, nie przypadkowo:
        </p>
        <ul>
      ...
      <div className="prose-article">
        ...
        <p>
          ...
          mówić krócej i ostrożniej. Zamiast tego lektor notuje błędy podczas twojej wypowiedzi i
          wraca do nich po jej zakończeniu. W praktyce wygląda to tak:
        </p>
        <p>
          Mówisz: <em>„Yesterday I go to the doctor because I have a headache since two days.”</em>{" "}
          Lektor nie przerywa. Po wypowiedzi wraca do trzech rzeczy: czasu przeszłego („I went”),
          przyimka przy chorobie („I&nbsp;had had a headache for two days”) i szyku zdania
          przyczynowego. Poprawiasz, powtarzasz poprawną wersję głośno, i lecicie dalej.
        ...
        <p>
          ...
          między dźwiękami. Polski i angielski system dźwięków różnią się w miejscach, których
          większość osób nawet nie podejrzewa. Klasyczny przykład to długość samogłoski w parach
          takich jak „ship” i „sheep”: po polsku nie ma tego rozróżnienia, więc ucho go nie szuka,
          dopóki ktoś świadomie go nie wytrenuje. Podobnie jest z bezdźwięcznym „th” w „think”.
          Większość Polaków zastępuje je „s” albo „f”, bo w polskim ten dźwięk po prostu nie
          istnieje. Dlatego ćwiczymy takie pary obok siebie: mózg najpierw uczy się słyszeć
          różnicę, dopiero potem próbuje ją wypowiedzieć.
        </p>
      </div>
