...
export const levels: Level[] = [
  {
    ...
    sampleCanDo: [
      ...
      "Zamówisz jedzenie w restauracji i zrozumiesz odpowiedź kelnera, nawet jeśli nie znasz każdego słowa.",
  ...
  },
  {
    ...
    whatChanges:
      "Poszerzamy zestaw sytuacji, w których poruszasz się swobodnie: praca, zakupy, drobne problemy do rozwiązania. Zaczynamy też pracować nad płynnością, czyli mówieniem bez długich pauz na szukanie słowa.",
    sampleCanDo: [
  ...
  },
  {
    ...
    startingPoint:
      "Sporo osób utyka właśnie tu na lata, bo B1 wystarcza, żeby jakoś sobie radzić, więc motywacja do dalszej nauki spada. To najczęstszy poziom osób zapisujących się z myślą „umiem się dogadać, ale chcę przestać się jąkać”.",
    whatChanges:
      "Pracujemy nad wyrażaniem opinii, nie tylko nad relacjonowaniem faktów. Chodzi o zdania zaczynające się od „uważam, że” albo „z drugiej strony”, nie tylko „chcę” i „potrzebuję”.",
    sampleCanDo: [
  ...
  },
  {
    ...
    startingPoint:
      "Tu trafiają osoby, którym angielski jest potrzebny konkretnie: do awansu, zmiany pracy, przeprowadzki, albo dlatego że w firmie nagle wszystkie spotkania są po angielsku. Znajomość języka już jest. Brakuje precyzji i pewności siebie.",
    whatChanges:
    ...
    sampleCanDo: [
      ...
      "Obronisz swoje stanowisko w dyskusji z native speakerem, nawet pod presją czasu.",
  ...
  },
  {
    ...
    startingPoint:
      "Osoby na tym poziomie zwykle już świetnie się komunikują. Problem leży gdzie indziej: w drobnych błędach, które powtarzają się od lat, bo nikt ich nigdy nie poprawił, oraz w poczuciu, że brzmią bardziej sztywno, niż by chcieli.",
    whatChanges:
      "Praca punktowa nad utrwalonymi błędami, bo każdy ma swój indywidualny zestaw, rozbudowa słownictwa abstrakcyjnego i idiomatycznego, ćwiczenie naturalnej intonacji, żeby wypowiedź brzmiała płynnie, nie jak czytana z kartki.",
    sampleCanDo: [
